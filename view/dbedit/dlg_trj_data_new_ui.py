...
class Ui_CDlgTrjDataNEW(object):
    def setupUi(self, CDlgTrjDataNEW):
        ...
        CDlgTrjDataNEW.setTabOrder(self.qtwPrcTab, self.qtwPage)
        CDlgTrjDataNEW.setTabOrder(self.qtwPage, self.qtwTabTrj)
        CDlgTrjDataNEW.setTabOrder(self.qtwTabTrj, self.btnUp)
        CDlgTrjDataNEW.setTabOrder(self.btnUp, self.btnDown)
        CDlgTrjDataNEW.setTabOrder(self.btnDown, self.btnTrjNew)
        CDlgTrjDataNEW.setTabOrder(self.btnTrjNew, self.btnTrjDel)
        CDlgTrjDataNEW.setTabOrder(self.btnTrjDel, self.cbxTCrd)
        CDlgTrjDataNEW.setTabOrder(self.cbxTCrd, self.dsbCartX)
        CDlgTrjDataNEW.setTabOrder(self.dsbCartX, self.dsbCartY)
        CDlgTrjDataNEW.setTabOrder(self.dsbCartY, self.dsbCartZ)
        CDlgTrjDataNEW.setTabOrder(self.dsbCartZ, self.sbxTrjVel)
        CDlgTrjDataNEW.setTabOrder(self.sbxTrjVel, self.cbxTrjPrc)
        CDlgTrjDataNEW.setTabOrder(self.cbxTrjPrc, self.sbxNavProa)
        CDlgTrjDataNEW.setTabOrder(self.sbxNavProa, self.sbxNavAlt)
        CDlgTrjDataNEW.setTabOrder(self.sbxNavAlt, self.sbxNavVel)
        CDlgTrjDataNEW.setTabOrder(self.sbxNavVel, self.cbxNavPrc)
        CDlgTrjDataNEW.setTabOrder(self.cbxNavPrc, self.cbxEspFixo)
        CDlgTrjDataNEW.setTabOrder(self.cbxEspFixo, self.cbxEspSent)
        CDlgTrjDataNEW.setTabOrder(self.cbxEspSent, self.sbxEspRumo)
        CDlgTrjDataNEW.setTabOrder(self.sbxEspRumo, self.cbxEspProc)
        CDlgTrjDataNEW.setTabOrder(self.cbxEspProc, self.sbxPolAlt)
        CDlgTrjDataNEW.setTabOrder(self.sbxPolAlt, self.sbxPFixDist)
        CDlgTrjDataNEW.setTabOrder(self.sbxPFixDist, self.cbxPFixFixo)
        CDlgTrjDataNEW.setTabOrder(self.cbxPFixFixo, self.sbxPFixAzim)
        CDlgTrjDataNEW.setTabOrder(self.sbxPFixAzim, self.qleGeoLat)
        CDlgTrjDataNEW.setTabOrder(self.qleGeoLat, self.sbxPolDist)
        CDlgTrjDataNEW.setTabOrder(self.sbxPolDist, self.qleGeoLng)
        CDlgTrjDataNEW.setTabOrder(self.qleGeoLng, self.qsbGeoAlt)
        CDlgTrjDataNEW.setTabOrder(self.qsbGeoAlt, self.sbxPolAzim)
    ...
    def retranslateUi(self, CDlgTrjDataNEW):
        ...
        self.gbxTrjPos.setTitle(_translate("CDlgTrjDataNEW", "Posicão", None))
        self.lblCartX.setText(_translate("CDlgTrjDataNEW", "X:", None))
        self.lblCartY.setText(_translate("CDlgTrjDataNEW", "Y:", None))
        self.lblCartZ.setText(_translate("CDlgTrjDataNEW", "Z:", None))
        self.dsbCartX.setSuffix(_translate("CDlgTrjDataNEW", " m", None))
        self.dsbCartY.setSuffix(_translate("CDlgTrjDataNEW", " m", None))
        self.dsbCartZ.setSuffix(_translate("CDlgTrjDataNEW", " ft", None))
        self.lblPFixDist.setText(_translate("CDlgTrjDataNEW", "Distância:", None))
        self.sbxPFixDist.setSuffix(_translate("CDlgTrjDataNEW", " m", None))
        self.lblPFixAzim.setText(_translate("CDlgTrjDataNEW", "Azimute:", None))
        self.sbxPFixAzim.setSuffix(_translate("CDlgTrjDataNEW", " °", None))
        self.lblPFixFixo.setText(_translate("CDlgTrjDataNEW", "Fixo:", None))
        self.lblGeoLat.setText(_translate("CDlgTrjDataNEW", "Latitude:", None))
        self.lblGeoLng.setText(_translate("CDlgTrjDataNEW", "Longitude:", None))
        self.lblGeoAlt.setText(_translate("CDlgTrjDataNEW", "Altitude:", None))
        self.qsbGeoAlt.setSuffix(_translate("CDlgTrjDataNEW", " ft", None))
        self.lblPolDist.setText(_translate("CDlgTrjDataNEW", "Distância:", None))
        self.lblPolAzim.setText(_translate("CDlgTrjDataNEW", "Azimute:", None))
        self.lblPolAlt.setText(_translate("CDlgTrjDataNEW", "Altitude:", None))
        self.sbxPolDist.setSuffix(_translate("CDlgTrjDataNEW", " m", None))
        self.sbxPolAzim.setSuffix(_translate("CDlgTrjDataNEW", " °", None))
        self.sbxPolAlt.setSuffix(_translate("CDlgTrjDataNEW", " ft", None))
        self.gbxTrjVel.setTitle(_translate("CDlgTrjDataNEW", "Velocidade", None))
        self.sbxTrjVel.setSuffix(_translate("CDlgTrjDataNEW", " kt", None))
        self.gbxPrjProc.setTitle(_translate("CDlgTrjDataNEW", "Procedimento", None))
        self.qtwPage.setTabText(self.qtwPage.indexOf(self.pagTrj), _translate("CDlgTrjDataNEW", "Trajetórias", None))
        self.lblNavProa.setText(_translate("CDlgTrjDataNEW", "Proa:", None))
        self.lblNavAlt.setText(_translate("CDlgTrjDataNEW", "Altitude:", None))
        self.lblNavVel.setText(_translate("CDlgTrjDataNEW", "Velocidade:", None))
        self.sbxNavProa.setSpecialValueText(_translate("CDlgTrjDataNEW", "Manter Atual", None))
        self.sbxNavProa.setSuffix(_translate("CDlgTrjDataNEW", " °", None))
        self.sbxNavVel.setSpecialValueText(_translate("CDlgTrjDataNEW", "Manter Atual", None))
        self.sbxNavVel.setSuffix(_translate("CDlgTrjDataNEW", " kt", None))
        self.sbxNavAlt.setSpecialValueText(_translate("CDlgTrjDataNEW", "Manter Atual", None))
        self.sbxNavAlt.setSuffix(_translate("CDlgTrjDataNEW", " ft", None))
        self.gbxNavPrc.setTitle(_translate("CDlgTrjDataNEW", "Procedimento", None))
        self.qtwPage.setTabText(self.qtwPage.indexOf(self.pagNav), _translate("CDlgTrjDataNEW", "Navegacão", None))
        self.lblEspFixo.setText(_translate("CDlgTrjDataNEW", "Fixo:", None))
        self.lblEspSent.setText(_translate("CDlgTrjDataNEW", "Sentido:", None))
        self.lblEspRumo.setText(_translate("CDlgTrjDataNEW", "Rumo:", None))
        self.sbxEspRumo.setSuffix(_translate("CDlgTrjDataNEW", " °", None))
        self.gbxEspProc.setTitle(_translate("CDlgTrjDataNEW", "Procedimento", None))
        self.qtwPage.setTabText(self.qtwPage.indexOf(self.pagEsp), _translate("CDlgTrjDataNEW", "Esperas", None))
        self.btnNew.setText(_translate("CDlgTrjDataNEW", "Novo", None))
        self.btnDel.setText(_translate("CDlgTrjDataNEW", "Remove", None))
