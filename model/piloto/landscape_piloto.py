...
# < class CLandscapePiloto >-----------------------------------------------------------------------

class CLandscapePiloto(land.CLandscapeBasic):
    """
    ...
    def __init__(self, f_model, fs_dir, fs_location):
        ...
        # init super class
        super(CLandscapePiloto, self).__init__(f_model)
    ...
    def load_xml(self, fs_filename):
        ...
        if not l_data_file.isOpen():
            # logger
            l_log = logging.getLogger("CLandscapePiloto::load_xml")
