...
# Form implementation generated from reading ui file './dlg_sub_data_new.ui'
#
...
class Ui_CDlgSubDataNEW(object):
    def setupUi(self, CDlgSubDataNEW):
        CDlgSubDataNEW.setObjectName(_fromUtf8("CDlgSubDataNEW"))
        CDlgSubDataNEW.setWindowModality(QtCore.Qt.WindowModal)
        CDlgSubDataNEW.resize(587, 665)
        CDlgSubDataNEW.setLocale(QtCore.QLocale(QtCore.QLocale.Portuguese, QtCore.QLocale.Brazil))
        CDlgSubDataNEW.setSizeGripEnabled(True)
        CDlgSubDataNEW.setModal(True)
        self.horizontalLayout_4 = QtGui.QHBoxLayout(CDlgSubDataNEW)
        self.horizontalLayout_4.setObjectName(_fromUtf8("horizontalLayout_4"))
        self.splitter_2 = QtGui.QSplitter(CDlgSubDataNEW)
        ...
        self.retranslateUi(CDlgSubDataNEW)
        self.qtwPage.setCurrentIndex(2)
        self.stkTCrd.setCurrentIndex(3)
        QtCore.QMetaObject.connectSlotsByName(CDlgSubDataNEW)
        CDlgSubDataNEW.setTabOrder(self.qtwPrcTab, self.qtwPage)
        CDlgSubDataNEW.setTabOrder(self.qtwPage, self.qtwTabTrj)
        CDlgSubDataNEW.setTabOrder(self.qtwTabTrj, self.btnUp)
        CDlgSubDataNEW.setTabOrder(self.btnUp, self.btnDown)
        CDlgSubDataNEW.setTabOrder(self.btnDown, self.btnTrjNew)
        CDlgSubDataNEW.setTabOrder(self.btnTrjNew, self.btnTrjDel)
        CDlgSubDataNEW.setTabOrder(self.btnTrjDel, self.cbxTCrd)
        CDlgSubDataNEW.setTabOrder(self.cbxTCrd, self.dsbCartX)
        CDlgSubDataNEW.setTabOrder(self.dsbCartX, self.dsbCartY)
        CDlgSubDataNEW.setTabOrder(self.dsbCartY, self.dsbCartZ)
        CDlgSubDataNEW.setTabOrder(self.dsbCartZ, self.sbxTrjVel)
        CDlgSubDataNEW.setTabOrder(self.sbxTrjVel, self.cbxTrjPrc)
        CDlgSubDataNEW.setTabOrder(self.cbxTrjPrc, self.sbxNavProa)
        CDlgSubDataNEW.setTabOrder(self.sbxNavProa, self.sbxNavAlt)
        CDlgSubDataNEW.setTabOrder(self.sbxNavAlt, self.sbxNavVel)
        CDlgSubDataNEW.setTabOrder(self.sbxNavVel, self.cbxNavPrc)
        CDlgSubDataNEW.setTabOrder(self.cbxNavPrc, self.cbxEspFixo)
        CDlgSubDataNEW.setTabOrder(self.cbxEspFixo, self.cbxEspSent)
        CDlgSubDataNEW.setTabOrder(self.cbxEspSent, self.sbxEspRumo)
        CDlgSubDataNEW.setTabOrder(self.sbxEspRumo, self.cbxEspProc)
        CDlgSubDataNEW.setTabOrder(self.cbxEspProc, self.sbxPolAlt)
        CDlgSubDataNEW.setTabOrder(self.sbxPolAlt, self.sbxPFixDist)
        CDlgSubDataNEW.setTabOrder(self.sbxPFixDist, self.cbxPFixFixo)
        CDlgSubDataNEW.setTabOrder(self.cbxPFixFixo, self.sbxPFixAzim)
        CDlgSubDataNEW.setTabOrder(self.sbxPFixAzim, self.qleGeoLat)
        CDlgSubDataNEW.setTabOrder(self.qleGeoLat, self.sbxPolDist)
        CDlgSubDataNEW.setTabOrder(self.sbxPolDist, self.qleGeoLng)
        CDlgSubDataNEW.setTabOrder(self.qleGeoLng, self.qsbGeoAlt)
        CDlgSubDataNEW.setTabOrder(self.qsbGeoAlt, self.sbxPolAzim)

    def retranslateUi(self, CDlgSubDataNEW):
        CDlgSubDataNEW.setWindowTitle(_translate("CDlgSubDataNEW", "Edição de Subidas", None))
        self.lblPrcDesc.setText(_translate("CDlgSubDataNEW", "Descrição:", None))
        self.lblPrcID.setText(_translate("CDlgSubDataNEW", "Indicativo:", None))
        self.txtPrcID.setText(_translate("CDlgSubDataNEW", "PRC001", None))
        self.gbxTrjPts.setTitle(_translate("CDlgSubDataNEW", "Pontos da Trajetória", None))
        self.btnTrjNew.setText(_translate("CDlgSubDataNEW", "Novo", None))
        self.btnTrjDel.setText(_translate("CDlgSubDataNEW", "Remove", None))
        self.gbxTrjPos.setTitle(_translate("CDlgSubDataNEW", "Posicão", None))
        self.lblCartX.setText(_translate("CDlgSubDataNEW", "X:", None))
        self.lblCartY.setText(_translate("CDlgSubDataNEW", "Y:", None))
        self.lblCartZ.setText(_translate("CDlgSubDataNEW", "Z:", None))
        self.dsbCartX.setSuffix(_translate("CDlgSubDataNEW", " m", None))
        self.dsbCartY.setSuffix(_translate("CDlgSubDataNEW", " m", None))
        self.dsbCartZ.setSuffix(_translate("CDlgSubDataNEW", " ft", None))
        self.lblPFixDist.setText(_translate("CDlgSubDataNEW", "Distância:", None))
        self.sbxPFixDist.setSuffix(_translate("CDlgSubDataNEW", " m", None))
        self.lblPFixAzim.setText(_translate("CDlgSubDataNEW", "Azimute:", None))
        self.sbxPFixAzim.setSuffix(_translate("CDlgSubDataNEW", " °", None))
        self.lblPFixFixo.setText(_translate("CDlgSubDataNEW", "Fixo:", None))
        self.lblGeoLat.setText(_translate("CDlgSubDataNEW", "Latitude:", None))
        self.lblGeoLng.setText(_translate("CDlgSubDataNEW", "Longitude:", None))
        self.lblGeoAlt.setText(_translate("CDlgSubDataNEW", "Altitude:", None))
        self.qsbGeoAlt.setSuffix(_translate("CDlgSubDataNEW", " ft", None))
        self.lblPolDist.setText(_translate("CDlgSubDataNEW", "Distância:", None))
        self.lblPolAzim.setText(_translate("CDlgSubDataNEW", "Azimute:", None))
        self.lblPolAlt.setText(_translate("CDlgSubDataNEW", "Altitude:", None))
        self.sbxPolDist.setSuffix(_translate("CDlgSubDataNEW", " m", None))
        self.sbxPolAzim.setSuffix(_translate("CDlgSubDataNEW", " °", None))
        self.sbxPolAlt.setSuffix(_translate("CDlgSubDataNEW", " ft", None))
        self.gbxTrjVel.setTitle(_translate("CDlgSubDataNEW", "Velocidade", None))
        self.sbxTrjVel.setSuffix(_translate("CDlgSubDataNEW", " kt", None))
        self.gbxPrjProc.setTitle(_translate("CDlgSubDataNEW", "Procedimento", None))
        self.qtwPage.setTabText(self.qtwPage.indexOf(self.pagTrj), _translate("CDlgSubDataNEW", "Trajetórias", None))
        self.lblNavProa.setText(_translate("CDlgSubDataNEW", "Proa:", None))
        self.lblNavAlt.setText(_translate("CDlgSubDataNEW", "Altitude:", None))
        self.lblNavVel.setText(_translate("CDlgSubDataNEW", "Velocidade:", None))
        self.sbxNavProa.setSpecialValueText(_translate("CDlgSubDataNEW", "Manter Atual", None))
        self.sbxNavProa.setSuffix(_translate("CDlgSubDataNEW", " °", None))
        self.sbxNavVel.setSpecialValueText(_translate("CDlgSubDataNEW", "Manter Atual", None))
        self.sbxNavVel.setSuffix(_translate("CDlgSubDataNEW", " kt", None))
        self.sbxNavAlt.setSpecialValueText(_translate("CDlgSubDataNEW", "Manter Atual", None))
        self.sbxNavAlt.setSuffix(_translate("CDlgSubDataNEW", " ft", None))
        self.gbxNavPrc.setTitle(_translate("CDlgSubDataNEW", "Procedimento", None))
        self.qtwPage.setTabText(self.qtwPage.indexOf(self.pagNav), _translate("CDlgSubDataNEW", "Navegacão", None))
        self.lblEspFixo.setText(_translate("CDlgSubDataNEW", "Fixo:", None))
        self.lblEspSent.setText(_translate("CDlgSubDataNEW", "Sentido:", None))
        self.lblEspRumo.setText(_translate("CDlgSubDataNEW", "Rumo:", None))
        self.sbxEspRumo.setSuffix(_translate("CDlgSubDataNEW", " °", None))
        self.gbxEspProc.setTitle(_translate("CDlgSubDataNEW", "Procedimento", None))
        self.qtwPage.setTabText(self.qtwPage.indexOf(self.pagEsp), _translate("CDlgSubDataNEW", "Esperas", None))
        self.btnNew.setText(_translate("CDlgSubDataNEW", "Novo", None))
        self.btnDel.setText(_translate("CDlgSubDataNEW", "Remove", None))
