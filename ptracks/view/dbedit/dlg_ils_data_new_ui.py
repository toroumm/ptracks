...
# Form implementation generated from reading ui file './dlg_ils_data_new.ui'
#
...
class Ui_CDlgIlsDataNEW(object):
    def setupUi(self, CDlgIlsDataNEW):
        CDlgIlsDataNEW.setObjectName(_fromUtf8("CDlgIlsDataNEW"))
        CDlgIlsDataNEW.setWindowModality(QtCore.Qt.WindowModal)
        CDlgIlsDataNEW.resize(587, 665)
        CDlgIlsDataNEW.setLocale(QtCore.QLocale(QtCore.QLocale.Portuguese, QtCore.QLocale.Brazil))
        CDlgIlsDataNEW.setSizeGripEnabled(True)
        CDlgIlsDataNEW.setModal(True)
        self.horizontalLayout_4 = QtGui.QHBoxLayout(CDlgIlsDataNEW)
        self.horizontalLayout_4.setObjectName(_fromUtf8("horizontalLayout_4"))
        self.splitter_2 = QtGui.QSplitter(CDlgIlsDataNEW)
        ...
        self.retranslateUi(CDlgIlsDataNEW)
        self.qtwPage.setCurrentIndex(2)
        self.stkTCrd.setCurrentIndex(3)
        QtCore.QMetaObject.connectSlotsByName(CDlgIlsDataNEW)
        CDlgIlsDataNEW.setTabOrder(self.qtwPrcTab, self.qtwPage)
        CDlgIlsDataNEW.setTabOrder(self.qtwPage, self.qtwTabTrj)
        CDlgIlsDataNEW.setTabOrder(self.qtwTabTrj, self.btnUp)
        CDlgIlsDataNEW.setTabOrder(self.btnUp, self.btnDown)
        CDlgIlsDataNEW.setTabOrder(self.btnDown, self.btnTrjNew)
        CDlgIlsDataNEW.setTabOrder(self.btnTrjNew, self.btnTrjDel)
        CDlgIlsDataNEW.setTabOrder(self.btnTrjDel, self.cbxTCrd)
        CDlgIlsDataNEW.setTabOrder(self.cbxTCrd, self.dsbCartX)
        CDlgIlsDataNEW.setTabOrder(self.dsbCartX, self.dsbCartY)
        CDlgIlsDataNEW.setTabOrder(self.dsbCartY, self.dsbCartZ)
        CDlgIlsDataNEW.setTabOrder(self.dsbCartZ, self.sbxTrjVel)
        CDlgIlsDataNEW.setTabOrder(self.sbxTrjVel, self.cbxTrjPrc)
        CDlgIlsDataNEW.setTabOrder(self.cbxTrjPrc, self.sbxNavProa)
        CDlgIlsDataNEW.setTabOrder(self.sbxNavProa, self.sbxNavAlt)
        CDlgIlsDataNEW.setTabOrder(self.sbxNavAlt, self.sbxNavVel)
        CDlgIlsDataNEW.setTabOrder(self.sbxNavVel, self.cbxNavPrc)
        CDlgIlsDataNEW.setTabOrder(self.cbxNavPrc, self.cbxEspFixo)
        CDlgIlsDataNEW.setTabOrder(self.cbxEspFixo, self.cbxEspSent)
        CDlgIlsDataNEW.setTabOrder(self.cbxEspSent, self.sbxEspRumo)
        CDlgIlsDataNEW.setTabOrder(self.sbxEspRumo, self.cbxEspProc)
        CDlgIlsDataNEW.setTabOrder(self.cbxEspProc, self.sbxPolAlt)
        CDlgIlsDataNEW.setTabOrder(self.sbxPolAlt, self.sbxPFixDist)
        CDlgIlsDataNEW.setTabOrder(self.sbxPFixDist, self.cbxPFixFixo)
        CDlgIlsDataNEW.setTabOrder(self.cbxPFixFixo, self.sbxPFixAzim)
        CDlgIlsDataNEW.setTabOrder(self.sbxPFixAzim, self.qleGeoLat)
        CDlgIlsDataNEW.setTabOrder(self.qleGeoLat, self.sbxPolDist)
        CDlgIlsDataNEW.setTabOrder(self.sbxPolDist, self.qleGeoLng)
        CDlgIlsDataNEW.setTabOrder(self.qleGeoLng, self.qsbGeoAlt)
        CDlgIlsDataNEW.setTabOrder(self.qsbGeoAlt, self.sbxPolAzim)

    def retranslateUi(self, CDlgIlsDataNEW):
        CDlgIlsDataNEW.setWindowTitle(_translate("CDlgIlsDataNEW", "Edição de ILSs", None))
        self.lblPrcDesc.setText(_translate("CDlgIlsDataNEW", "Descrição:", None))
        self.lblPrcID.setText(_translate("CDlgIlsDataNEW", "Indicativo:", None))
        self.txtPrcID.setText(_translate("CDlgIlsDataNEW", "PRC001", None))
        self.gbxTrjPts.setTitle(_translate("CDlgIlsDataNEW", "Pontos da Trajetória", None))
        self.btnTrjNew.setText(_translate("CDlgIlsDataNEW", "Novo", None))
        self.btnTrjDel.setText(_translate("CDlgIlsDataNEW", "Remove", None))
        self.gbxTrjPos.setTitle(_translate("CDlgIlsDataNEW", "Posicão", None))
        self.lblCartX.setText(_translate("CDlgIlsDataNEW", "X:", None))
        self.lblCartY.setText(_translate("CDlgIlsDataNEW", "Y:", None))
        self.lblCartZ.setText(_translate("CDlgIlsDataNEW", "Z:", None))
        self.dsbCartX.setSuffix(_translate("CDlgIlsDataNEW", " m", None))
        self.dsbCartY.setSuffix(_translate("CDlgIlsDataNEW", " m", None))
        self.dsbCartZ.setSuffix(_translate("CDlgIlsDataNEW", " ft", None))
        self.lblPFixDist.setText(_translate("CDlgIlsDataNEW", "Distância:", None))
        self.sbxPFixDist.setSuffix(_translate("CDlgIlsDataNEW", " m", None))
        self.lblPFixAzim.setText(_translate("CDlgIlsDataNEW", "Azimute:", None))
        self.sbxPFixAzim.setSuffix(_translate("CDlgIlsDataNEW", " °", None))
        self.lblPFixFixo.setText(_translate("CDlgIlsDataNEW", "Fixo:", None))
        self.lblGeoLat.setText(_translate("CDlgIlsDataNEW", "Latitude:", None))
        self.lblGeoLng.setText(_translate("CDlgIlsDataNEW", "Longitude:", None))
        self.lblGeoAlt.setText(_translate("CDlgIlsDataNEW", "Altitude:", None))
        self.qsbGeoAlt.setSuffix(_translate("CDlgIlsDataNEW", " ft", None))
        self.lblPolDist.setText(_translate("CDlgIlsDataNEW", "Distância:", None))
        self.lblPolAzim.setText(_translate("CDlgIlsDataNEW", "Azimute:", None))
        self.lblPolAlt.setText(_translate("CDlgIlsDataNEW", "Altitude:", None))
        self.sbxPolDist.setSuffix(_translate("CDlgIlsDataNEW", " m", None))
        self.sbxPolAzim.setSuffix(_translate("CDlgIlsDataNEW", " °", None))
        self.sbxPolAlt.setSuffix(_translate("CDlgIlsDataNEW", " ft", None))
        self.gbxTrjVel.setTitle(_translate("CDlgIlsDataNEW", "Velocidade", None))
        self.sbxTrjVel.setSuffix(_translate("CDlgIlsDataNEW", " kt", None))
        self.gbxPrjProc.setTitle(_translate("CDlgIlsDataNEW", "Procedimento", None))
        self.qtwPage.setTabText(self.qtwPage.indexOf(self.pagTrj), _translate("CDlgIlsDataNEW", "Trajetórias", None))
        self.lblNavProa.setText(_translate("CDlgIlsDataNEW", "Proa:", None))
        self.lblNavAlt.setText(_translate("CDlgIlsDataNEW", "Altitude:", None))
        self.lblNavVel.setText(_translate("CDlgIlsDataNEW", "Velocidade:", None))
        self.sbxNavProa.setSpecialValueText(_translate("CDlgIlsDataNEW", "Manter Atual", None))
        self.sbxNavProa.setSuffix(_translate("CDlgIlsDataNEW", " °", None))
        self.sbxNavVel.setSpecialValueText(_translate("CDlgIlsDataNEW", "Manter Atual", None))
        self.sbxNavVel.setSuffix(_translate("CDlgIlsDataNEW", " kt", None))
        self.sbxNavAlt.setSpecialValueText(_translate("CDlgIlsDataNEW", "Manter Atual", None))
        self.sbxNavAlt.setSuffix(_translate("CDlgIlsDataNEW", " ft", None))
        self.gbxNavPrc.setTitle(_translate("CDlgIlsDataNEW", "Procedimento", None))
        self.qtwPage.setTabText(self.qtwPage.indexOf(self.pagNav), _translate("CDlgIlsDataNEW", "Navegacão", None))
        self.lblEspFixo.setText(_translate("CDlgIlsDataNEW", "Fixo:", None))
        self.lblEspSent.setText(_translate("CDlgIlsDataNEW", "Sentido:", None))
        self.lblEspRumo.setText(_translate("CDlgIlsDataNEW", "Rumo:", None))
        self.sbxEspRumo.setSuffix(_translate("CDlgIlsDataNEW", " °", None))
        self.gbxEspProc.setTitle(_translate("CDlgIlsDataNEW", "Procedimento", None))
        self.qtwPage.setTabText(self.qtwPage.indexOf(self.pagEsp), _translate("CDlgIlsDataNEW", "Esperas", None))
        self.btnNew.setText(_translate("CDlgIlsDataNEW", "Novo", None))
        self.btnDel.setText(_translate("CDlgIlsDataNEW", "Remove", None))
