...
# Form implementation generated from reading ui file './dlg_ape_data_new.ui'
#
...
class Ui_CDlgApeDataNEW(object):
    def setupUi(self, CDlgApeDataNEW):
        CDlgApeDataNEW.setObjectName(_fromUtf8("CDlgApeDataNEW"))
        CDlgApeDataNEW.setWindowModality(QtCore.Qt.WindowModal)
        CDlgApeDataNEW.resize(587, 665)
        CDlgApeDataNEW.setLocale(QtCore.QLocale(QtCore.QLocale.Portuguese, QtCore.QLocale.Brazil))
        CDlgApeDataNEW.setSizeGripEnabled(True)
        CDlgApeDataNEW.setModal(True)
        self.horizontalLayout_4 = QtGui.QHBoxLayout(CDlgApeDataNEW)
        self.horizontalLayout_4.setObjectName(_fromUtf8("horizontalLayout_4"))
        self.splitter_2 = QtGui.QSplitter(CDlgApeDataNEW)
        ...
        self.retranslateUi(CDlgApeDataNEW)
        self.qtwPage.setCurrentIndex(2)
        self.stkTCrd.setCurrentIndex(3)
        QtCore.QMetaObject.connectSlotsByName(CDlgApeDataNEW)
        CDlgApeDataNEW.setTabOrder(self.qtwPrcTab, self.qtwPage)
        CDlgApeDataNEW.setTabOrder(self.qtwPage, self.qtwTabTrj)
        CDlgApeDataNEW.setTabOrder(self.qtwTabTrj, self.btnUp)
        CDlgApeDataNEW.setTabOrder(self.btnUp, self.btnDown)
        CDlgApeDataNEW.setTabOrder(self.btnDown, self.btnTrjNew)
        CDlgApeDataNEW.setTabOrder(self.btnTrjNew, self.btnTrjDel)
        CDlgApeDataNEW.setTabOrder(self.btnTrjDel, self.cbxTCrd)
        CDlgApeDataNEW.setTabOrder(self.cbxTCrd, self.dsbCartX)
        CDlgApeDataNEW.setTabOrder(self.dsbCartX, self.dsbCartY)
        CDlgApeDataNEW.setTabOrder(self.dsbCartY, self.dsbCartZ)
        CDlgApeDataNEW.setTabOrder(self.dsbCartZ, self.sbxTrjVel)
        CDlgApeDataNEW.setTabOrder(self.sbxTrjVel, self.cbxTrjPrc)
        CDlgApeDataNEW.setTabOrder(self.cbxTrjPrc, self.sbxNavProa)
        CDlgApeDataNEW.setTabOrder(self.sbxNavProa, self.sbxNavAlt)
        CDlgApeDataNEW.setTabOrder(self.sbxNavAlt, self.sbxNavVel)
        CDlgApeDataNEW.setTabOrder(self.sbxNavVel, self.cbxNavPrc)
        CDlgApeDataNEW.setTabOrder(self.cbxNavPrc, self.cbxEspFixo)
        CDlgApeDataNEW.setTabOrder(self.cbxEspFixo, self.cbxEspSent)
        CDlgApeDataNEW.setTabOrder(self.cbxEspSent, self.sbxEspRumo)
        CDlgApeDataNEW.setTabOrder(self.sbxEspRumo, self.cbxEspProc)
        CDlgApeDataNEW.setTabOrder(self.cbxEspProc, self.sbxPolAlt)
        CDlgApeDataNEW.setTabOrder(self.sbxPolAlt, self.sbxPFixDist)
        CDlgApeDataNEW.setTabOrder(self.sbxPFixDist, self.cbxPFixFixo)
        CDlgApeDataNEW.setTabOrder(self.cbxPFixFixo, self.sbxPFixAzim)
        CDlgApeDataNEW.setTabOrder(self.sbxPFixAzim, self.qleGeoLat)
        CDlgApeDataNEW.setTabOrder(self.qleGeoLat, self.sbxPolDist)
        CDlgApeDataNEW.setTabOrder(self.sbxPolDist, self.qleGeoLng)
        CDlgApeDataNEW.setTabOrder(self.qleGeoLng, self.qsbGeoAlt)
        CDlgApeDataNEW.setTabOrder(self.qsbGeoAlt, self.sbxPolAzim)

    def retranslateUi(self, CDlgApeDataNEW):
        CDlgApeDataNEW.setWindowTitle(_translate("CDlgApeDataNEW", "Edição de Aproximações", None))
        self.lblPrcDesc.setText(_translate("CDlgApeDataNEW", "Descrição:", None))
        self.lblPrcID.setText(_translate("CDlgApeDataNEW", "Indicativo:", None))
        self.txtPrcID.setText(_translate("CDlgApeDataNEW", "PRC001", None))
        self.gbxTrjPts.setTitle(_translate("CDlgApeDataNEW", "Pontos da Trajetória", None))
        self.btnTrjNew.setText(_translate("CDlgApeDataNEW", "Novo", None))
        self.btnTrjDel.setText(_translate("CDlgApeDataNEW", "Remove", None))
        self.gbxTrjPos.setTitle(_translate("CDlgApeDataNEW", "Posicão", None))
        self.lblCartX.setText(_translate("CDlgApeDataNEW", "X:", None))
        self.lblCartY.setText(_translate("CDlgApeDataNEW", "Y:", None))
        self.lblCartZ.setText(_translate("CDlgApeDataNEW", "Z:", None))
        self.dsbCartX.setSuffix(_translate("CDlgApeDataNEW", " m", None))
        self.dsbCartY.setSuffix(_translate("CDlgApeDataNEW", " m", None))
        self.dsbCartZ.setSuffix(_translate("CDlgApeDataNEW", " ft", None))
        self.lblPFixDist.setText(_translate("CDlgApeDataNEW", "Distância:", None))
        self.sbxPFixDist.setSuffix(_translate("CDlgApeDataNEW", " m", None))
        self.lblPFixAzim.setText(_translate("CDlgApeDataNEW", "Azimute:", None))
        self.sbxPFixAzim.setSuffix(_translate("CDlgApeDataNEW", " °", None))
        self.lblPFixFixo.setText(_translate("CDlgApeDataNEW", "Fixo:", None))
        self.lblGeoLat.setText(_translate("CDlgApeDataNEW", "Latitude:", None))
        self.lblGeoLng.setText(_translate("CDlgApeDataNEW", "Longitude:", None))
        self.lblGeoAlt.setText(_translate("CDlgApeDataNEW", "Altitude:", None))
        self.qsbGeoAlt.setSuffix(_translate("CDlgApeDataNEW", " ft", None))
        self.lblPolDist.setText(_translate("CDlgApeDataNEW", "Distância:", None))
        self.lblPolAzim.setText(_translate("CDlgApeDataNEW", "Azimute:", None))
        self.lblPolAlt.setText(_translate("CDlgApeDataNEW", "Altitude:", None))
        self.sbxPolDist.setSuffix(_translate("CDlgApeDataNEW", " m", None))
        self.sbxPolAzim.setSuffix(_translate("CDlgApeDataNEW", " °", None))
        self.sbxPolAlt.setSuffix(_translate("CDlgApeDataNEW", " ft", None))
        self.gbxTrjVel.setTitle(_translate("CDlgApeDataNEW", "Velocidade", None))
        self.sbxTrjVel.setSuffix(_translate("CDlgApeDataNEW", " kt", None))
        self.gbxPrjProc.setTitle(_translate("CDlgApeDataNEW", "Procedimento", None))
        self.qtwPage.setTabText(self.qtwPage.indexOf(self.pagTrj), _translate("CDlgApeDataNEW", "Trajetórias", None))
        self.lblNavProa.setText(_translate("CDlgApeDataNEW", "Proa:", None))
        self.lblNavAlt.setText(_translate("CDlgApeDataNEW", "Altitude:", None))
        self.lblNavVel.setText(_translate("CDlgApeDataNEW", "Velocidade:", None))
        self.sbxNavProa.setSpecialValueText(_translate("CDlgApeDataNEW", "Manter Atual", None))
        self.sbxNavProa.setSuffix(_translate("CDlgApeDataNEW", " °", None))
        self.sbxNavVel.setSpecialValueText(_translate("CDlgApeDataNEW", "Manter Atual", None))
        self.sbxNavVel.setSuffix(_translate("CDlgApeDataNEW", " kt", None))
        self.sbxNavAlt.setSpecialValueText(_translate("CDlgApeDataNEW", "Manter Atual", None))
        self.sbxNavAlt.setSuffix(_translate("CDlgApeDataNEW", " ft", None))
        self.gbxNavPrc.setTitle(_translate("CDlgApeDataNEW", "Procedimento", None))
        self.qtwPage.setTabText(self.qtwPage.indexOf(self.pagNav), _translate("CDlgApeDataNEW", "Navegacão", None))
        self.lblEspFixo.setText(_translate("CDlgApeDataNEW", "Fixo:", None))
        self.lblEspSent.setText(_translate("CDlgApeDataNEW", "Sentido:", None))
        self.lblEspRumo.setText(_translate("CDlgApeDataNEW", "Rumo:", None))
        self.sbxEspRumo.setSuffix(_translate("CDlgApeDataNEW", " °", None))
        self.gbxEspProc.setTitle(_translate("CDlgApeDataNEW", "Procedimento", None))
        self.qtwPage.setTabText(self.qtwPage.indexOf(self.pagEsp), _translate("CDlgApeDataNEW", "Esperas", None))
        self.btnNew.setText(_translate("CDlgApeDataNEW", "Novo", None))
        self.btnDel.setText(_translate("CDlgApeDataNEW", "Remove", None))
