...
# Form implementation generated from reading ui file './dlg_esp_data_new.ui'
#
...
class Ui_CDlgEspDataNEW(object):
    def setupUi(self, CDlgEspDataNEW):
        CDlgEspDataNEW.setObjectName(_fromUtf8("CDlgEspDataNEW"))
        CDlgEspDataNEW.setWindowModality(QtCore.Qt.WindowModal)
        CDlgEspDataNEW.resize(587, 665)
        CDlgEspDataNEW.setLocale(QtCore.QLocale(QtCore.QLocale.Portuguese, QtCore.QLocale.Brazil))
        CDlgEspDataNEW.setSizeGripEnabled(True)
        CDlgEspDataNEW.setModal(True)
        self.horizontalLayout_4 = QtGui.QHBoxLayout(CDlgEspDataNEW)
        self.horizontalLayout_4.setObjectName(_fromUtf8("horizontalLayout_4"))
        self.splitter_2 = QtGui.QSplitter(CDlgEspDataNEW)
        ...
        self.retranslateUi(CDlgEspDataNEW)
        self.qtwPage.setCurrentIndex(2)
        self.stkTCrd.setCurrentIndex(3)
        QtCore.QMetaObject.connectSlotsByName(CDlgEspDataNEW)
        CDlgEspDataNEW.setTabOrder(self.qtwPrcTab, self.qtwPage)
        CDlgEspDataNEW.setTabOrder(self.qtwPage, self.qtwTabTrj)
        CDlgEspDataNEW.setTabOrder(self.qtwTabTrj, self.btnUp)
        CDlgEspDataNEW.setTabOrder(self.btnUp, self.btnDown)
        CDlgEspDataNEW.setTabOrder(self.btnDown, self.btnTrjNew)
        CDlgEspDataNEW.setTabOrder(self.btnTrjNew, self.btnTrjDel)
        CDlgEspDataNEW.setTabOrder(self.btnTrjDel, self.cbxTCrd)
        CDlgEspDataNEW.setTabOrder(self.cbxTCrd, self.dsbCartX)
        CDlgEspDataNEW.setTabOrder(self.dsbCartX, self.dsbCartY)
        CDlgEspDataNEW.setTabOrder(self.dsbCartY, self.dsbCartZ)
        CDlgEspDataNEW.setTabOrder(self.dsbCartZ, self.sbxTrjVel)
        CDlgEspDataNEW.setTabOrder(self.sbxTrjVel, self.cbxTrjPrc)
        CDlgEspDataNEW.setTabOrder(self.cbxTrjPrc, self.sbxNavProa)
        CDlgEspDataNEW.setTabOrder(self.sbxNavProa, self.sbxNavAlt)
        CDlgEspDataNEW.setTabOrder(self.sbxNavAlt, self.sbxNavVel)
        CDlgEspDataNEW.setTabOrder(self.sbxNavVel, self.cbxNavPrc)
        CDlgEspDataNEW.setTabOrder(self.cbxNavPrc, self.cbxEspFixo)
        CDlgEspDataNEW.setTabOrder(self.cbxEspFixo, self.cbxEspSent)
        CDlgEspDataNEW.setTabOrder(self.cbxEspSent, self.sbxEspRumo)
        CDlgEspDataNEW.setTabOrder(self.sbxEspRumo, self.cbxEspProc)
        CDlgEspDataNEW.setTabOrder(self.cbxEspProc, self.sbxPolAlt)
        CDlgEspDataNEW.setTabOrder(self.sbxPolAlt, self.sbxPFixDist)
        CDlgEspDataNEW.setTabOrder(self.sbxPFixDist, self.cbxPFixFixo)
        CDlgEspDataNEW.setTabOrder(self.cbxPFixFixo, self.sbxPFixAzim)
        CDlgEspDataNEW.setTabOrder(self.sbxPFixAzim, self.qleGeoLat)
        CDlgEspDataNEW.setTabOrder(self.qleGeoLat, self.sbxPolDist)
        CDlgEspDataNEW.setTabOrder(self.sbxPolDist, self.qleGeoLng)
        CDlgEspDataNEW.setTabOrder(self.qleGeoLng, self.qsbGeoAlt)
        CDlgEspDataNEW.setTabOrder(self.qsbGeoAlt, self.sbxPolAzim)

    def retranslateUi(self, CDlgEspDataNEW):
        CDlgEspDataNEW.setWindowTitle(_translate("CDlgEspDataNEW", "Edição de Esperas", None))
        self.lblPrcDesc.setText(_translate("CDlgEspDataNEW", "Descrição:", None))
        self.lblPrcID.setText(_translate("CDlgEspDataNEW", "Indicativo:", None))
        self.txtPrcID.setText(_translate("CDlgEspDataNEW", "PRC001", None))
        self.gbxTrjPts.setTitle(_translate("CDlgEspDataNEW", "Pontos da Trajetória", None))
        self.btnTrjNew.setText(_translate("CDlgEspDataNEW", "Novo", None))
        self.btnTrjDel.setText(_translate("CDlgEspDataNEW", "Remove", None))
        self.gbxTrjPos.setTitle(_translate("CDlgEspDataNEW", "Posicão", None))
        self.lblCartX.setText(_translate("CDlgEspDataNEW", "X:", None))
        self.lblCartY.setText(_translate("CDlgEspDataNEW", "Y:", None))
        self.lblCartZ.setText(_translate("CDlgEspDataNEW", "Z:", None))
        self.dsbCartX.setSuffix(_translate("CDlgEspDataNEW", " m", None))
        self.dsbCartY.setSuffix(_translate("CDlgEspDataNEW", " m", None))
        self.dsbCartZ.setSuffix(_translate("CDlgEspDataNEW", " ft", None))
        self.lblPFixDist.setText(_translate("CDlgEspDataNEW", "Distância:", None))
        self.sbxPFixDist.setSuffix(_translate("CDlgEspDataNEW", " m", None))
        self.lblPFixAzim.setText(_translate("CDlgEspDataNEW", "Azimute:", None))
        self.sbxPFixAzim.setSuffix(_translate("CDlgEspDataNEW", " °", None))
        self.lblPFixFixo.setText(_translate("CDlgEspDataNEW", "Fixo:", None))
        self.lblGeoLat.setText(_translate("CDlgEspDataNEW", "Latitude:", None))
        self.lblGeoLng.setText(_translate("CDlgEspDataNEW", "Longitude:", None))
        self.lblGeoAlt.setText(_translate("CDlgEspDataNEW", "Altitude:", None))
        self.qsbGeoAlt.setSuffix(_translate("CDlgEspDataNEW", " ft", None))
        self.lblPolDist.setText(_translate("CDlgEspDataNEW", "Distância:", None))
        self.lblPolAzim.setText(_translate("CDlgEspDataNEW", "Azimute:", None))
        self.lblPolAlt.setText(_translate("CDlgEspDataNEW", "Altitude:", None))
        self.sbxPolDist.setSuffix(_translate("CDlgEspDataNEW", " m", None))
        self.sbxPolAzim.setSuffix(_translate("CDlgEspDataNEW", " °", None))
        self.sbxPolAlt.setSuffix(_translate("CDlgEspDataNEW", " ft", None))
        self.gbxTrjVel.setTitle(_translate("CDlgEspDataNEW", "Velocidade", None))
        self.sbxTrjVel.setSuffix(_translate("CDlgEspDataNEW", " kt", None))
        self.gbxPrjProc.setTitle(_translate("CDlgEspDataNEW", "Procedimento", None))
        self.qtwPage.setTabText(self.qtwPage.indexOf(self.pagTrj), _translate("CDlgEspDataNEW", "Trajetórias", None))
        self.lblNavProa.setText(_translate("CDlgEspDataNEW", "Proa:", None))
        self.lblNavAlt.setText(_translate("CDlgEspDataNEW", "Altitude:", None))
        self.lblNavVel.setText(_translate("CDlgEspDataNEW", "Velocidade:", None))
        self.sbxNavProa.setSpecialValueText(_translate("CDlgEspDataNEW", "Manter Atual", None))
        self.sbxNavProa.setSuffix(_translate("CDlgEspDataNEW", " °", None))
        self.sbxNavVel.setSpecialValueText(_translate("CDlgEspDataNEW", "Manter Atual", None))
        self.sbxNavVel.setSuffix(_translate("CDlgEspDataNEW", " kt", None))
        self.sbxNavAlt.setSpecialValueText(_translate("CDlgEspDataNEW", "Manter Atual", None))
        self.sbxNavAlt.setSuffix(_translate("CDlgEspDataNEW", " ft", None))
        self.gbxNavPrc.setTitle(_translate("CDlgEspDataNEW", "Procedimento", None))
        self.qtwPage.setTabText(self.qtwPage.indexOf(self.pagNav), _translate("CDlgEspDataNEW", "Navegacão", None))
        self.lblEspFixo.setText(_translate("CDlgEspDataNEW", "Fixo:", None))
        self.lblEspSent.setText(_translate("CDlgEspDataNEW", "Sentido:", None))
        self.lblEspRumo.setText(_translate("CDlgEspDataNEW", "Rumo:", None))
        self.sbxEspRumo.setSuffix(_translate("CDlgEspDataNEW", " °", None))
        self.gbxEspProc.setTitle(_translate("CDlgEspDataNEW", "Procedimento", None))
        self.qtwPage.setTabText(self.qtwPage.indexOf(self.pagEsp), _translate("CDlgEspDataNEW", "Esperas", None))
        self.btnNew.setText(_translate("CDlgEspDataNEW", "Novo", None))
        self.btnDel.setText(_translate("CDlgEspDataNEW", "Remove", None))
