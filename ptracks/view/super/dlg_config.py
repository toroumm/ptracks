...
try:
    import ptracks.view.resources.super_resources_rc2
    
except ImportError:
    import ptracks.view.resources.super_resources_rc3

# view
# import view.super.page_model as wpm
import ptracks.view.super.pag_config as pcfg
import ptracks.view.super.pag_query as pqry
import ptracks.view.super.pag_update as pupd
